...
import { CommentEntity, EvaluationEntity, VideoEntity, PlaylistEntity, SubscriptionEntity, ReportEntity, MessageEntity, ChatNotificationEntity, HistoricEntity } from "./";
...
export class UserEntity extends AbstractEntity{
    ...
    @OneToMany(() => HistoricEntity, (historic) => historic.user)
